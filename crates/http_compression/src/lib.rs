...
//! enables [`Format::Zlib`][compressors::format::Format]. Raw RFC 1951 DEFLATE
...
//! | `compression_unsupported` | A compression format that is not enabled was seen, under [`UnsupportedCompression::Fail`] |
//!

...
every supported codec, then name them:

```rust
let client = builder
    .automatic_response_decompression(&[DecompressionMethod::Gzip])
    .build();
```
...
[`DecompressionMethod::ALL`][__link82] asks for everything the build can
decompress.

Decompression is lazy, so a malformed body fails when it is read rather than when the response
arrives, and that failure therefore does not trigger a retry. It is also bounded only by each
format’s own expansion ceiling, so anything that buffers a body it did not produce should bound
it with [`response_body_options`][__link83].

For server-side compression and decompression, use the
[`http_compression`][__link84] crate directly.
...
[`automatic_response_decompression`][__link85] asks
for it.
...
* **`compression-gzip`**: Links the `gzip` codec (RFC 1952) for
  ...
  [`DecompressionMethod::Gzip`][__link86]. The legacy `x-gzip` token selects
  it too.

* **`compression-deflate`**: Links the `deflate` codec and adds
  [`DecompressionMethod::Deflate`][__link87]. Despite the token, the HTTP
...
* **`compression-brotli`**: Links the `br` codec (RFC 7932) and adds
  [`DecompressionMethod::Brotli`][__link88].

* **`compression-zstd`**: Links the `zstd` codec (RFC 8878) and adds
  [`DecompressionMethod::Zstd`][__link89].

* **`compression-all`**: Enables all four codec features above. Use
  [`DecompressionMethod::ALL`][__link90] to request decompression with all of them.
...
This crate was developed as part of <a href="https://github.com/microsoft/oxidizer">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/oxidizer/tree/main/crates/fetch">source code</a>.
 ...
 [__cargo_doc2readme_dependencies_info]: ggGmYW0CYXZlMC43LjJhdIQb11VxC_uAPOQbtUn4Wx2-BfAbid3Nt1Y27Pobprn8Z6FjFy9hYvRhcoQbNTMndbsXFj4bJskR3LnxD0Ab8XOC84_NSvQbdNeNg4FiZqZhZIeCZWJ5dGVzZjEuMTIuMIJoYnl0ZXNidWZlMC45LjCCZWZldGNoZjAuMTYuMYJvaHR0cF9leHRlbnNpb25zZjAuMTAuMIJnbGF5ZXJlZGUwLjMuNoJoc2VhdGJlbHRlMC44LjCCbXRlbXBsYXRlZF91cmllMC41LjA
 ...
 [__link11]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpClient::put
 [__link12]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpClient::delete
 [__link13]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpClient::request
 [__link14]: https://docs.rs/http_extensions/0.10.0/http_extensions/?search=HttpRequestBuilder
 [__link15]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpClientBuilder::base_uri
 ...
 [__link19]: https://docs.rs/fetch/0.16.1/fetch/?search=http::Response
 ...
 [__link28]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpRequestBuilder::fetch_text
 [__link29]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpRequestBuilder::fetch_bytes
 [__link3]: https://docs.rs/fetch/0.16.1/fetch/custom/index.html
 [__link30]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpRequestBuilder::fetch_json
 [__link31]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpRequestBuilder::fetch_json_ref
 [__link32]: https://docs.rs/http_extensions/0.10.0/http_extensions/?search=HttpBody
 [__link33]: https://docs.rs/fetch/0.16.1/fetch/?search=http::Response
 [__link34]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpResponse::ensure_success
 [__link35]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpRequestBuilder::fetch_text_body
 [__link36]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpRequestBuilder::fetch_bytes_body
 [__link37]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpRequestBuilder::fetch_json_body
 [__link38]: https://crates.io/crates/templated_uri/0.5.0
 [__link39]: https://docs.rs/templated_uri/0.5.0/templated_uri/?search=Uri
 [__link4]: https://docs.rs/fetch/0.16.1/fetch/?search=custom::create_builder
 [__link40]: https://datatracker.ietf.org/doc/html/rfc6570
 [__link41]: https://docs.rs/templated_uri/0.5.0/templated_uri/?search=Uri
 [__link42]: https://docs.rs/fetch/0.16.1/fetch/?search=handlers::Logging
 ...
 [__link45]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpRequestBuilder::json
 [__link46]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpRequestBuilder::fetch_json
 [__link47]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpRequestBuilder::fetch_json_ref
 [__link48]: https://docs.rs/fetch/0.16.1/fetch/?search=Json
 [__link49]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpBody::into_json
 [__link5]: https://docs.rs/reqwest/
 [__link50]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpRequestBuilder::fetch_json_body
 [__link51]: https://docs.rs/fetch/0.16.1/fetch/?search=Json
 ...
 [__link55]: https://docs.rs/fetch/0.16.1/fetch/custom/index.html
 [__link56]: https://docs.rs/fetch/0.16.1/fetch/?search=custom::create_builder
 [__link57]: https://docs.rs/fetch/0.16.1/fetch/?search=pipeline::StandardRequestPipeline
 [__link58]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpClientBuilder::standard_pipeline
 [__link59]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpClientBuilder::custom_pipeline
 [__link6]: https://docs.rs/hyper/
 [__link60]: https://docs.rs/fetch/0.16.1/fetch/?search=handlers::Dispatch
 ...
 [__link68]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpClient
 [__link69]: https://docs.rs/templated_uri/0.5.0/templated_uri/?search=Uri
 [__link7]: https://docs.rs/fetch/0.16.1/fetch/custom/index.html
 ...
 [__link73]: https://docs.rs/fetch/0.16.1/fetch/http/index.html
 ...
 [__link77]: https://docs.rs/fetch/0.16.1/fetch/?search=pipeline::StandardRequestPipeline
 [__link78]: https://docs.rs/rustls
 [__link79]: https://docs.rs/aws-lc-rs
 [__link8]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpClient::builder_tokio
 [__link80]: https://docs.rs/rustls-platform-verifier
 [__link81]: https://docs.rs/fetch/0.16.1/fetch/?search=tls::TlsOptions::builder_rustls
 [__link82]: https://docs.rs/fetch/0.16.1/fetch/?search=options::DecompressionMethod::ALL
 [__link83]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpClientBuilder::response_body_options
 [__link84]: https://docs.rs/http_compression
 [__link85]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpClientBuilder::automatic_response_decompression
 [__link86]: https://docs.rs/fetch/0.16.1/fetch/?search=options::DecompressionMethod
 [__link87]: https://docs.rs/fetch/0.16.1/fetch/?search=options::DecompressionMethod
 [__link88]: https://docs.rs/fetch/0.16.1/fetch/?search=options::DecompressionMethod
 [__link89]: https://docs.rs/fetch/0.16.1/fetch/?search=options::DecompressionMethod
 [__link9]: https://docs.rs/fetch/0.16.1/fetch/?search=HttpClient::get
 [__link90]: https://docs.rs/fetch/0.16.1/fetch/?search=options::DecompressionMethod::ALL
